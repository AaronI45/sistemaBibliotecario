...
public class FXMLRegistrarRecursoDaniadoController implements Initializable {
    ...
    private void clicRegistrar(ActionEvent event) {
        ...
        if(recursoSeleccionado != null){
            boolean validacionRecursoDaniado = Utilidades.mostrarDialogoConfirmacion("¿Está seguro de registrar el recurso documental como dañado?", 
                    "El recurso documental será registrado como dañado, en caso de no tener más copias disponibles, el recurso tendrá un estado de no disponible"
                            + "\n¿aceptar el registro de recurso dañado?");
            ...
            Utilidades.mostrarAlertaSimple("Error de selección", "El recurso documental no ha sido seleccionado", 
                    Alert.AlertType.ERROR);
        }
    }
